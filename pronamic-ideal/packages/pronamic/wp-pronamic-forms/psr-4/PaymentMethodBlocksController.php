...
final class PaymentMethodBlocksController {
	...
	private function get_payment_methods() {
		return [
			[
				'id'    => 'bancontact',
				'title' => \__( 'Bancontact payment method', 'pronamic-ideal' ),
				'label' => $this->get_label( 'bancontact', \__( 'Bancontact', 'pronamic-ideal' ) ),
			],
			[
				'id'    => 'card',
				'title' => \__( 'Card payment method', 'pronamic-ideal' ),
				'label' => $this->get_label( 'card', \__( 'Card', 'pronamic-ideal' ) ),
			],
			[
				'id'    => 'ideal',
				'title' => \__( 'iDEAL | Wero payment method', 'pronamic-ideal' ),
				'label' => $this->get_label( 'ideal', \__( 'iDEAL | Wero', 'pronamic-ideal' ) ),
			],
		];
	}
	...
	private function maybe_add_radio_field( $variations, $block_type ) {
		...
		$variations[] = [
			...
			'title'       => \__( 'Payment method field', 'pronamic-ideal' ),
			'keywords'    => [
				\__( 'payment method', 'pronamic-ideal' ),
				\__( 'Bancontact', 'pronamic-ideal' ),
				\__( 'Card', 'pronamic-ideal' ),
