...
const TEMPLATE = [
	...
	[
		'pronamic/form-field',
		{
			label: __('Subject', 'pronamic-ideal'),
			required: true,
		},
	],
	[
		'pronamic/form-field',
		{
			label: __('Message', 'pronamic-ideal'),
			required: true,
			type: 'textarea',
		},
	],
	...
	variations: [
		{
			...
			title: __('Donation form', 'pronamic-ideal'),
			category: 'pronamic-forms',
			keywords: [
				__('donation', 'pronamic-ideal'),
				__('donate', 'pronamic-ideal'),
				__('fundraiser', 'pronamic-ideal'),
				__('charity', 'pronamic-ideal'),
				__('contribute', 'pronamic-ideal'),
				__('contribution', 'pronamic-ideal'),
				__('nonprofit', 'pronamic-ideal'),
				__('gift', 'pronamic-ideal'),
			],
			attributes: {
			...
			innerBlocks: [
				[
					...
					[
						['core/paragraph', { content: __('Your form has been submitted successfully.', 'pronamic-ideal') }]
					]
				],
				[
					'pronamic/form-submission-notification',
					...
					[
						['core/paragraph', { content: __('There was an error submitting your form.', 'pronamic-ideal') }]
					]
				],
				[
					'pronamic/form-field',
