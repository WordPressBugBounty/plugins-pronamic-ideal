...
<div class="wp-block-pronamic-form-field"><div class="wp-block-pronamic-form-label"><label><?php \esc_html_e( 'Name', 'pronamic-ideal' ); ?></label></div><div class="wp-block-pronamic-form-control"><input required class="wp-block-pronamic-form-control__element" value="" type="text"/></div></div>
...
<div class="wp-block-button"><button type="submit" class="wp-block-button__link wp-element-button"><?php \esc_html_e( 'Donate', 'pronamic-ideal' ); ?></button></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></form>
<!-- /wp:pronamic/form -->
