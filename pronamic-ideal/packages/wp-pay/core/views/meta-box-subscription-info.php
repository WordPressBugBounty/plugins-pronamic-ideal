		...
		<td>
			<div class="pronamic-pay-action-link">
				...
				<div class="pronamic-pay-action-link-clipboard">
					<button type="button" class="button button-small pronamic-pay-clipboard" data-clipboard-text="<?php echo \esc_url( $url ); ?>"><?php \esc_html_e( 'Copy URL to clipboard', 'pronamic-ideal' ); ?></button>
